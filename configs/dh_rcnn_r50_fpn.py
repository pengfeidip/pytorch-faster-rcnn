...
test_cfg = dict(
    ...
    rcnn=dict(min_score=0.05, nms_iou=0.5, max_per_img=100, nms_type='official')
) 
...
data = dict(
    train=dict(
        imgs_per_gpu=2,
        ann_file='/home/lee/datasets/voc2007_trainval/voc2007_trainval_no_diff_.json',
    ...
    test=dict(
        imgs_per_gpu=2,
        ann_file='/home/lee/datasets/voc2007_test/voc2007_test_no_diff_.json',
        img_prefix='/home/lee/datasets/voc2007_comb/VOC2007/JPEGImages',
